                ...
                <div class="card">
                    <div id="content-body">
                        <div class="p-3 p-md-5">
                            <h5>Kayıt Ol</h5>
                            <p>
                                <small class="text-muted">Hemen ücretsiz kayıt olarak pazarlamaya başlayın.</small>
                            </p>
                            ...
                            <?php register_result(); ?>
                                ...
                                <div class="form-group">
                                    <label>Ad</label>
                                    <input type="text" name="name" class="form-control" placeholder="Adınızı girin">
                                </div>
                                <div class="form-group">
                                    <label>Soyad</label>
                                    <input type="text" name="surname" class="form-control" placeholder="Soyadınızı girin">
                                </div>
                                <div class="form-group">
                                    <label>Parola</label>
                                    <input type="password" name="pass" class="form-control" placeholder="Parolanızı girin">
                                </div>
                                <div class="form-group">
                                    <label>Parola Tekrar</label>
                                    <input type="password" name="pass2" class="form-control" placeholder="Parolanızı tekrar girin">
                                </div>
                                <div class="form-group">
                                    <label>E-Posta</label>

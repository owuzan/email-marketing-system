                    ...
                    <div class="page-hero page-container " id="page-hero">
                        <div class="padding d-flex">
                            <div class="page-title">
                                <h2 class="text-md text-highlight">Listeyi Düzenle</h2>
                            ...
                            <div class="row">
                                ...
                                if(isset($_POST['delete-list'])) {
                                    ...
                                    if(isset($_POST['list-id'])) {
                                        ...
                                        header('Location:' . get_option('site_url') . '/admin/lists');
                                        exit;
                                ...
                                <?php if(isset($_POST['edited-list'])) {
                                    ...
                                    <div class="alert alert-danger dismissible fade show" role="alert">
                                        ...
                                        <span class="mx-2">Liste güncellenemedi: Hiç bir seçim yapmamış olabilirsiniz veya liste adı boş olabilir.</span>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Kapat">
                                            <span aria-hidden="true">×</span>
                                        </button>
                                    </div>
                                ...
                                <?php } } ?>
                                    <div class="card">
                                        ...
                                        if(isset($_POST['edit-list'])) {
                                            ...
                                            $list_query = $db -> query("SELECT * FROM lists WHERE id='$list_id'");
                                            $result = $list_query -> fetch(PDO::FETCH_ASSOC);
                                        ...
                                        ?>
                                            <form action="" method="POST">
                                                ...
                                                <input type="hidden" name="list-id" value="<?php echo $list_id ?>">
                                                    ...
                                                    <input type="text" name="list-title" value="<?php echo $result['list_title']; ?>" class="form-control" id="list-title">
                                                </div>
                                                <div class="form-group">
                                                                        ...
                                                                        <span class="text-color">
                                                                            <div class="checkbox">
                                                                                <label class="ui-check">
                                                                                    <input type="checkbox" name="selected-emails[]" <?php if(strpos($result['emails'], $row['id'])) { echo 'checked="checked"'; } ?> value="<?php echo $row['id']; ?>">
                                                ...
                                                <button type="submit" name="edited-list" class="btn btn-success float-right">Listeyi Güncelle</button>
                                                <button type="button" name="delete-modal" data-toggle="modal" data-target="#delete-list-modal" class="btn btn-danger float-right mr-2">Listeyi Sil</button>


                                                <div class="modal fade" id="delete-list-modal" tabindex="-1" role="dialog" aria-labelledby="delete-list-title" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="delete-list-title">Listeyi sil</h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <p>"<b><?php echo $result['list_title']; ?></b>" başlıklı listeyi silmek istediğinize emin misiniz?</p>                                                                
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="submit" name="delete-list" class="btn btn-sm btn-danger">Evet, sil</button>

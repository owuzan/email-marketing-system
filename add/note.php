                            ...
                            <div class="row">
                                ...
                                <?php if(isset($_POST['add-note'])) {
                                    ...
                                    <div class="alert alert-success dismissible fade show" role="alert">
                                        ...
                                        <span class="mx-2">Not başarıyla eklendi.</span>
                                    ...
                                    <div class="alert alert-danger dismissible fade show" role="alert">
                                        ...
                                        <span class="mx-2">Not eklenemedi: Başlık veya içerik boş olabilir.</span>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Kapat">
                                            <span aria-hidden="true">×</span>
                                        </button>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <form action="" method="POST">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="note-title" autofocus="autofocus" onfocus="this.select()" class="form-control" id="note-title">
                                                </div>
                                                <div class="form-group">
                                                    <label class="text-muted" for="note-content">Not içeriği</label>
                                                    <textarea class="form-control" name="note-content" id="note-content" rows="10"></textarea>
                                                </div>
                                                <button type="submit" name="add-note" class="btn btn-primary float-right">Kaydet</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>

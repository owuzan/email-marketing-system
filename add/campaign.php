            ...
            <div id="content" class="flex ">
                ...
                <div>
                    ...
                    <div class="page-content page-container" id="page-content">
                        ...
                        <?php if(isset($_POST['save-template'])) {
                            global $db;

                            $title = $_POST['campaign-name'];
                            $description = $_POST['campaign-description'];
                            $content = $_POST['campaign-template'];

                            $query = $db -> exec("INSERT INTO campaigns (campaign_title, campaign_description, campaign_content) VALUES ('$title', '$description', '$content')");

                        } ?>
                            <div class="card">
                                <div class="card-header">
                                    <strong>Kampanya Oluştur</strong>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="tab-content p-3">
                                                ...
                                                <div class="tab-pane active" id="tab1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="campaign-name" name="campaign-name" class="form-control" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Kampanya açıklaması</label>
                                                        <textarea class="form-control" id="campaign-description" name="campaign-description" rows="5" required=""></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="tab-pane" id="tab2">
                                                    <div class="form-row">
                                                        <textarea name="campaign-template" id="campaign-template"></textarea>
                                                    </div>
                                                ...
                                                <div class="tab-pane" id="tab3">
                                                    <div class="form-group">
                                                        <p>
                                                            <strong>Şablonu oluşturmak için son adım...</strong>
                                                        </p>
                                                        <p>Gerekli kontrolleri yaptıktan sonra kaydetmek için aşağıdaki butona tıklayarak tamamlayın.</p>
                                                        <button type="submit" name="save-template" class="btn btn-success btn-sm">Şablonu kaydet</button>
                                                    </div>
                                                </div>
                                                <div class="row py-3">
                                                    <div class="col-6">

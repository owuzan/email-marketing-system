                ...
                <div>
                    <div class="page-hero page-container " id="page-hero">
                        <div class="padding d-flex">
                            <div class="page-title">
                                <h2 class="text-md text-highlight">Listeler</h2>
                    ...
                    <div class="page-content page-container" id="page-content">
                        <div class="padding">
                            ...
                            $query = $db -> prepare("SELECT * FROM lists ORDER BY id DESC");
                            ...
                            foreach($query as $row) { ?>
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title"><?php echo $row['list_title']; ?></h5>
                                            <p class="card-text"><?php echo 'Bu listede kayıtlı <b>' . mb_substr_count($row['emails'], ' ') . '</b> e-posta adresi var.'; ?></p>

                                            <form action="<?php echo get_option('site_url') . '/edit/list'; ?>" method="POST" class="d-inline">
                                                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                                <button type="submit" name="edit-list" class="btn btn-sm btn-primary">Düzenle</button>
                                            </form>

                                            <form action="" method="POST" class="d-inline">
                                                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                                <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-list-modal-<?php echo $row['id']; ?>">Sil</button>
                                                <!-- Modal -->
                                                <div class="modal fade" id="delete-list-modal-<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="delete-list-title" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>"<b><?php echo $row['list_title']; ?></b>" başlıklı listeyi silmek istediğinize emin misiniz?</p>                                                                
                                                            </div>
                                                            <div class="modal-footer">
                                                                <input type="submit" name="delete-list" class="btn btn-sm btn-danger" value="Evet, sil">
                                            ...
                                            <small class="text-muted float-right mt-1"><?php echo date(get_option('date_format') . ' - ' . get_option('time_format'), strtotime($row['list_date'])); ?></small>
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
